...
const TRANSLATIONS: Record<Locale, TranslationKeys> = {
  "en": {
    ...
    "landing.pricing.free.feature1": "1 resume parse (try it)",
    "landing.pricing.free.feature2": "View only—no editing",
    ...
    "pricing.free.desc": "Try 1 resume parse. View only—no editing.",
    "pricing.free.feature1": "1 resume parse (try it)",
    "pricing.free.feature2": "View parsed data only—no editing",
  ...
  "es-MX": {
    ...
    "landing.pricing.free.feature1": "1 parse de currículum (pruébalo)",
    "landing.pricing.free.feature2": "Solo ver—sin editar",
    ...
    "pricing.free.desc": "Prueba 1 parse de currículum. Solo ver—sin editar.",
    "pricing.free.feature1": "1 parse de currículum (pruébalo)",
    "pricing.free.feature2": "Solo ver datos—sin editar",
