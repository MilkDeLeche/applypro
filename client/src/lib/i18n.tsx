...
const TRANSLATIONS: Record<Locale, TranslationKeys> = {
  "en": {
    ...
    "privacy.subtitle": "Unlike other autofill tools that monetize your data, SudoFillr keeps your information completely private.",
    "privacy.never_sold.title": "Never Sold",
    "privacy.never_sold.desc": "We never sell, share, or monetize your personal data. Ever.",
    "privacy.delete.title": "Delete Anytime",
    "privacy.delete.desc": "One-click to permanently delete all your data from our servers.",
    "privacy.encrypted.title": "Encrypted Storage",
    "privacy.encrypted.desc": "Your resume data is encrypted at rest and in transit.",
  ...
  "es-MX": {
    ...
    "privacy.subtitle": "A diferencia de otras herramientas de autocompletado que monetizan tus datos, SudoFillr mantiene tu información completamente privada.",
    "privacy.never_sold.title": "Nunca Vendidos",
    "privacy.never_sold.desc": "Nunca vendemos, compartimos o monetizamos tus datos personales. Jamás.",
    "privacy.delete.title": "Borra Cuando Quieras",
    "privacy.delete.desc": "Un clic para eliminar permanentemente todos tus datos de nuestros servidores.",
    "privacy.encrypted.title": "Almacenamiento Cifrado",
    "privacy.encrypted.desc": "Los datos de tu currículum están cifrados en reposo y en tránsito.",
  ...
  "es-CL": {
    ...
    "privacy.title": "La privacidad es nuestra",
    "privacy.highlight": "promesa",
    "privacy.subtitle": "A diferencia de otras herramientas que venden tus datos, SudoFillr mantiene tu info completamente privada. Así de simple.",
    "privacy.never_sold.title": "Nunca Vendidos",
    "privacy.never_sold.desc": "Nunca vendemos, compartimos o monetizamos tus datos personales. Palabra.",
    "privacy.delete.title": "Borra Cuando Quieras",
    "privacy.delete.desc": "Un clic y listo, se borran todos tus datos de nuestros servidores.",
    "privacy.encrypted.title": "Almacenamiento Cifrado",
    "privacy.encrypted.desc": "Los datos de tu currículum están cifrados y protegidos.",
